export default function AuthLayout({
    ...
    return (
        <div className="auth-shell relative flex min-h-screen items-center justify-center overflow-hidden bg-gradient-to-br from-secondary-50 via-surface-50 to-secondary-100 p-4 sm:p-6 md:p-8">
