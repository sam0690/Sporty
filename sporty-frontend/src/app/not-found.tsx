...
export default function NotFoundPage() {
  return (
    <main className="relative overflow-hidden bg-background text-foreground">
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top_left,_rgba(0,229,255,0.14),_transparent_45%),radial-gradient(circle_at_bottom_right,_rgba(255,61,129,0.08),_transparent_45%)]" />
