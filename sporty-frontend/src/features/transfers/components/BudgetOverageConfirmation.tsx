      ...
      <div className="w-full max-w-md overflow-hidden rounded-[3px] border border-warning/25 bg-surface-1 animate-in zoom-in-95 duration-200">
        ...
        <div className="p-6">
          <p className="text-sm text-fg-2">
            This transfer goes{" "}
            <span className="font-display tracking-[-0.02em] text-danger">
              {detail.shortfall}
            </span>{" "}
          ...
          <div className="mt-4 grid grid-cols-2 gap-3">
            <div className="rounded-[3px] border border-warning/20 bg-warning/8 p-3">
              <p className="font-sans text-[10px] font-700 uppercase tracking-[1.5px] text-warning">
                Points Cost
              </p>
              <p className="mt-1 font-display text-xl tracking-[-0.02em] text-fg-1">
                {detail.points_cost}
              </p>
            </div>
            <div className="rounded-[3px] border border-white/8 bg-surface-3 p-3">
              <p className="font-sans text-[10px] font-700 uppercase tracking-[1.5px] text-fg-3">
                Available
              </p>
              <p className="mt-1 font-display text-xl tracking-[-0.02em] text-fg-1">
          ...
          <div className="mt-6 flex flex-col gap-2">
            <button
              ...
              onClick={onConfirm}
              disabled={isLoading}
              className="w-full rounded-[3px] bg-warning py-3 font-sans text-xs font-700 uppercase tracking-[2px] text-surface-0 transition-colors hover:bg-[#ffe28a] disabled:cursor-not-allowed disabled:opacity-50"
            >
              {isLoading
                ? "Processing…"
