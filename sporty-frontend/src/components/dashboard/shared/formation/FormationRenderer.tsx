          ...
          {showSectionLabels ? (
            <div className="flex items-center justify-between gap-2 px-1 text-xs text-white/70">
              <div className="flex items-center gap-2">
                <span className="rounded-full border border-white/10 bg-white/5 px-2 py-1 font-semibold text-foreground">
                  {section.title}
                </span>
                {section.formationLabel ? (
                  <span className="rounded-full border border-accent-primary/25 bg-accent-primary/10 px-2 py-1 font-semibold text-accent-primary">
                    {section.formationLabel}
                  </span>
                ) : null}
              </div>
