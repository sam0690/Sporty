...
export function EmptyState({ leagueId, sport }: EmptyStateProps) {
  return (
    <section className="py-12 text-center">
      ...
      <h2 className="text-xl font-600 text-black">You don't have any players in this league yet</h2>
      ...
      <Link href="/transfers" className="mt-4 inline-flex rounded-[3px] bg-primary/100 px-4 py-2 text-white transition-colors hover:bg-primary/90">
        Go to Transfers
      </Link>
    </section>
  );
