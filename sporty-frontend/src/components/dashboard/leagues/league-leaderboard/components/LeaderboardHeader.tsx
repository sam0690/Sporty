...
export function LeaderboardHeader({ leagueName, sport, currentWeek, totalWeeks }: LeaderboardHeaderProps) {
  return (
    <header className="flex flex-wrap items-center justify-between gap-4">
      ...
      <p className="text-sm font-medium text-text-secondary">Season {currentWeek}/{totalWeeks}</p>
    </header>
  );
}
