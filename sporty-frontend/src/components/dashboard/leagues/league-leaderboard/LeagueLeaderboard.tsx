...
const mockLeaderboards: Record<string, LeaderboardData> = {
  "1": {
    ...
    groups: ["Overall"],
    standings: [
      { rank: 1, teamId: "team2", teamName: "Dunk FC", manager: "Mike T.", totalPoints: 245, weeklyAvg: 81.7, wins: 2, losses: 0, streak: "🔥2", group: "Overall", weeklyScores: { 1: 74, 2: 98, 3: 73 } },
      { rank: 2, teamId: "team1", teamName: "Goal Rush", manager: "John D.", totalPoints: 212, weeklyAvg: 70.7, wins: 1, losses: 1, streak: "❄️1", group: "Overall", weeklyScores: { 1: 70, 2: 66, 3: 76 } },
      { rank: 3, teamId: "team3", teamName: "FC United", manager: "Sarah K.", totalPoints: 198, weeklyAvg: 66.0, wins: 0, losses: 2, streak: "❄️2", group: "Overall", weeklyScores: { 1: 68, 2: 65, 3: 65 } },
      { rank: 4, teamId: "team4", teamName: "City FC", manager: "Alex R.", totalPoints: 187, weeklyAvg: 62.3, wins: 0, losses: 2, streak: "❄️2", group: "Overall", weeklyScores: { 1: 64, 2: 59, 3: 64 } },
    ],
  },
  "2": {
    leagueId: "2",
    ...
    standings: [
      { rank: 1, teamId: "team1", teamName: "Dunk Masters", manager: "John D.", totalPoints: 642, weeklyAvg: 128.4, wins: 4, losses: 1, streak: "🔥3", group: "East", weeklyScores: { 1: 118, 2: 122, 3: 158, 4: 119, 5: 125 } },
      { rank: 2, teamId: "team2", teamName: "Hoop Kings", manager: "Mike T.", totalPoints: 598, weeklyAvg: 119.6, wins: 3, losses: 2, streak: "🔥1", group: "West", weeklyScores: { 1: 110, 2: 120, 3: 126, 4: 114, 5: 128 } },
      { rank: 3, teamId: "team3", teamName: "Air Ballers", manager: "Sarah K.", totalPoints: 567, weeklyAvg: 113.4, wins: 2, losses: 3, streak: "❄️2", group: "East", weeklyScores: { 1: 108, 2: 116, 3: 113, 4: 119, 5: 111 } },
    ],
  },
  "3": {
    leagueId: "3",
    ...
    groups: ["Overall"],
    standings: [
      { rank: 1, teamId: "team1", teamName: "Boundary Blasters", manager: "Mike T.", totalPoints: 432, weeklyAvg: 108.0, wins: 3, losses: 1, streak: "🔥2", group: "Overall", weeklyScores: { 1: 104, 2: 112, 3: 103, 4: 113 } },
      { rank: 2, teamId: "team2", teamName: "Spin Kings", manager: "Sarah K.", totalPoints: 398, weeklyAvg: 99.5, wins: 2, losses: 2, streak: "❄️1", group: "Overall", weeklyScores: { 1: 98, 2: 102, 3: 101, 4: 97 } },
      { rank: 3, teamId: "team3", teamName: "Six Hitters", manager: "John D.", totalPoints: 387, weeklyAvg: 96.8, wins: 2, losses: 2, streak: "🔥1", group: "Overall", weeklyScores: { 1: 93, 2: 95, 3: 98, 4: 101 } },
    ],
  },
  "4": {
    leagueId: "4",
    ...
    statsHighlights: {
      topScorer: { name: "Nikola Jokic", team: "CrossSport Kings", points: 142 },
      highestWeeklyScore: { team: "AllStar United", score: 312, week: 2 },
      closestMatch: { matchup: "CrossSport Kings vs AllStar United", difference: 8 },
    },
    groups: ["Overall", "Group A", "Group B"],
    standings: [
      { rank: 1, teamId: "team2", teamName: "AllStar United", manager: "Mike T.", totalPoints: 942, weeklyAvg: 314.0, wins: 3, losses: 0, streak: "🔥3", group: "Group A", weeklyScores: { 1: 308, 2: 312, 3: 322 } },
      { rank: 2, teamId: "team1", teamName: "CrossSport Kings", manager: "John D.", totalPoints: 897, weeklyAvg: 299.0, wins: 2, losses: 1, streak: "🔥1", group: "Group A", weeklyScores: { 1: 294, 2: 297, 3: 306 } },
      { rank: 3, teamId: "team3", teamName: "Global Legends", manager: "Sarah K.", totalPoints: 856, weeklyAvg: 285.3, wins: 1, losses: 2, streak: "❄️1", group: "Group B", weeklyScores: { 1: 280, 2: 287, 3: 289 } },
    ],
  },
};
...
export function LeagueLeaderboard() {
  ...
  if (leaderboard.standings.length === 0) {
    return <EmptyState message="No leaderboard data available for this league." />;
  }
