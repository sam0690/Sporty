...
export function TransferFields({ leagueId }: TransferFieldsProps) {
  return (
    <section className="rounded-[3px] border border-emerald-200 bg-emerald-50 p-4">
      ...
      <Link
        ...
        className="mt-3 inline-flex rounded-[3px] border border-emerald-300 bg-white px-4 py-2 text-sm text-emerald-800 hover:bg-emerald-100"
      >
