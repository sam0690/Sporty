  ...
  if (!hasOpponent) {
    ...
    return (
      <section className="card-surface p-5 text-center animate-fade-soft">
        ...
        <p className="truncate font-sans text-xs font-700 uppercase tracking-[1px] text-fg-1">
          {yourTeamName}
        </p>
        <p className="mt-2 font-display text-5xl tracking-[-0.02em] text-accent">
          {yourScore}
        </p>
        ...
        <div className="mt-4 flex justify-center">
          <span
            className={
              isLeadingSolo
                ? "rounded-[3px] border border-accent/25 bg-accent/8 px-3 py-1 font-sans text-xs font-700 uppercase tracking-[2px] text-accent-dim"
                : "rounded-[3px] border border-white/8 bg-surface-3 px-3 py-1 font-sans text-xs font-700 uppercase tracking-[2px] text-fg-2"
            }
          >
    ...
    <section className="card-surface p-5 animate-fade-soft">
      ...
      <div className="grid grid-cols-[1fr_auto_1fr] items-center gap-3">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 font-display text-5xl tracking-[-0.02em] text-fg-3">
            {opponentScore}
          </p>
      ...
      <div className="mt-4 flex justify-center">
        {youAreLeader && leading ? (
          <span className="rounded-[3px] border border-accent/25 bg-accent/8 px-3 py-1 font-sans text-xs font-700 uppercase tracking-[2px] text-accent-dim">
            Top of the league
          </span>
        ) : leading ? (
          <span className="rounded-[3px] border border-accent/25 bg-accent/8 px-3 py-1 font-sans text-xs font-700 uppercase tracking-[2px] text-accent-dim">
          ...
          <span className="rounded-[3px] border border-white/8 bg-surface-3 px-3 py-1 font-sans text-xs font-700 uppercase tracking-[2px] text-fg-2">
