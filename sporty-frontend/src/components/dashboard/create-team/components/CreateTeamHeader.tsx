...
export function CreateTeamHeader({
  ...
  return (
    <header className="space-y-4 rounded-[3px] border border-[rgba(11,18,32,0.08)] bg-[#FFFFFF] p-5">
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div className="space-y-2">
          <div className="flex flex-wrap items-center gap-3">
            <h1 className="font-bebas text-4xl leading-none tracking-[2px] text-[#0B1220]">
              {leagueName}
            </h1>
            <span
              className={`rounded-[3px] px-2.5 py-1 font-barlow-condensed text-xs font-bold uppercase tracking-[1px] ${sportBadgeClass[sport]}`}
              aria-label={sport}
            >
      ...
      <div className="space-y-2">
        <div className="h-2 overflow-hidden rounded-[3px] bg-[#FFFFFF]">
          <div
            className="h-2 rounded-[3px] bg-[#DC2626] transition-[width] duration-300"
            style={{ width: `${progress}%` }}
          />
        </div>
        <p className="font-barlow-condensed text-xs font-bold uppercase tracking-[1px] text-[#6B7280]">
