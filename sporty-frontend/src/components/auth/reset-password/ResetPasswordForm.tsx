        ...
        <AuthPageShell
            hero={
                <AuthHeroImage
                    ...
                    bullets={["Minimum 6 characters", "At least one number", "At least one letter"]}
                />
            }
        >
            <Card className="animate-fade-in mx-auto w-full max-w-md rounded-2xl border border-gray-100 bg-white shadow-2xl">
                <CardHeader className="space-y-2 p-8 pb-4 sm:p-10 sm:pb-4">
                    ...
                    <CardTitle className="text-3xl font-bold text-primary-800 sm:text-4xl">Create new password</CardTitle>
                    <p className="text-sm text-text-secondary">Your new password must be different from previous</p>
                </CardHeader>
