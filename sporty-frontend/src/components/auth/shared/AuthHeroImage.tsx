...
export function AuthHeroImage({ title, subtitle, bullets = [] }: AuthHeroImageProps) {
  return (
    <div className="relative hidden min-h-[460px] overflow-hidden rounded-[3px] border border-accent/20 bg-gradient-to-br from-primary/10 via-white to-[#F4F4F9] shadow-strong md:block">
      ...
      <div className="relative z-10 flex h-full flex-col justify-end gap-2 p-7 text-white">
        <h3 className="font-bebas text-4xl leading-tight">{title}</h3>
