...
export function AuthPageShell({ children, hero }: AuthPageShellProps) {
  return (
    <section className="relative w-full overflow-hidden bg-[#F4F4F9] px-4 py-8 sm:px-6 sm:py-10">
      <div className="pointer-events-none absolute inset-0 -z-10 opacity-20 auth-dot-pattern" />
      <div className="pointer-events-none absolute -top-24 -left-24 -z-10 h-64 w-64 rounded-full bg-primary/20 blur-3xl" />
      <div className="pointer-events-none absolute -bottom-32 -right-32 -z-10 h-72 w-72 rounded-full bg-accent/20 blur-3xl" />
      <FloatingSportsIcons />
