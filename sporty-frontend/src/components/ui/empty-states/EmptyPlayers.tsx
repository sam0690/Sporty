...
export function EmptyPlayers() {
  return (
    <section className="rounded-[12px] border border-[rgba(255,255,255,0.08)] bg-[#121218] py-16 text-center">
      ...
      <Link
        href="/transfers"
        className="mt-4 inline-flex rounded-[10px] border border-[rgba(255,255,255,0.1)] px-6 py-2 text-[#f0f0f0] transition-colors hover:border-[rgba(232,251,37,0.3)]"
      >
        Browse Transfers
      </Link>
    </section>
