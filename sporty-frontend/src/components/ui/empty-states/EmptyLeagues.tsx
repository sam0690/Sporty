  ...
  return (
    <section className="card-surface py-16 text-center">
      ...
      <div className="mt-6 flex flex-wrap justify-center gap-3">
        <Link
          href="/join-league"
          className="rounded-[3px] bg-accent px-6 py-2 font-sans text-xs font-700 uppercase tracking-[2px] text-surface-0 transition-colors hover:bg-accent-bright"
        >
          Join League
        </Link>
        <Link
          href="/create-league"
          className="rounded-[3px] border border-white/8 px-6 py-2 font-sans text-xs font-700 uppercase tracking-[2px] text-fg-2 transition-colors hover:text-fg-1"
        >
          Create League
        </Link>
      </div>
