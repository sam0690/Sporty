  ...
  return (
    <section className="card-surface py-16 text-center">
      ...
      <button
        ...
        className="mt-6 rounded-[3px] border border-white/8 px-6 py-2 font-sans text-xs font-700 uppercase tracking-[2px] text-fg-2 transition-colors hover:text-fg-1"
      >
        Clear Filters
      </button>
    </section>
