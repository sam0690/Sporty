...
export function RightContent({ visual }: RightContentProps) {
  return (
    <div className="relative aspect-[4/3] overflow-hidden rounded-3xl border border-white/10 bg-surface/90 shadow-[0_24px_90px_rgba(0,0,0,0.45)]">
      <Image
        src={visual.imageSrc}
        alt={visual.imageAlt}
        fill
      ...
      <div className="absolute bottom-4 left-4 right-4 rounded-2xl border border-white/10 bg-black/45 p-3 backdrop-blur-md sm:p-4">
      ...
      <div className="absolute -bottom-6 -right-6 hidden gap-3 md:flex">
        <div className="relative h-24 w-24 overflow-hidden rounded-xl border border-white/10 shadow-hover">
          <Image
