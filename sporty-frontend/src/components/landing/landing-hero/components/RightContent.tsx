...
export function RightContent({ visual }: RightContentProps) {
  return (
    <div className="relative aspect-16/11 overflow-hidden rounded-2xl border border-surface-200 shadow-dropdown">
      ...
      <div className="absolute bottom-4 left-4 right-4 rounded-xl border border-surface-50/40 bg-primary/35 p-3 backdrop-blur-md sm:p-4">
        <p className="text-sm font-medium text-text-light">
          {visual.nextMatchLabel}
        </p>
        <div className="mt-2 h-2 w-full rounded-full bg-surface-50/40">
          <div
