...
def test_auto_pick_squad_respects_locked_players_and_budget() -> None:
    gk = make_player("Keeper", "football", "GKP", "5", "10", "ClubA")
    defender = make_player("Defender", "football", "DEF", "6", "9", "ClubB")
    pg = make_player("Guard", "basketball", "UNK", "7", "8", "ClubC")
    sg = make_player("Shooter", "basketball", "UNK", "8", "7", "ClubD")

    sport_config = {
        "sportType": "mixed",
        "totalBudget": Decimal("30"),
        "sports": [
            {"type": "football", "quota": 2, "positions": ["GKP", "DEF"], "maxPerClub": 3},
            {"type": "basketball", "quota": 2, "positions": ["UNK", "UNK"], "maxPerClub": 3},
        ],
    }
